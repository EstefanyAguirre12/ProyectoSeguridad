...
$reportNameYPos = 160;
$columnLabels = array( "Ocasion", "Productos");
setlocale(LC_ALL, '');
date_default_timezone_set('America/El_Salvador');
$time = strftime('%c');
$datos = new Ocasion;
$data = $datos->getCantidadO();
...
function Header()
{
  ...
  $textColour = array( 0, 0, 0 );
  $headerColour = array( 100, 100, 100 );
  $reportName = "Cantidad de Productos por Ocasion";
  $reportNameYPos = 160;
...
$pdf->Write( 6, $time);
$pdf->Ln( 12 );
$pdf->Write( 6, "En el siguiente reporte se muestran a continuacion los productos existentes por ocasion vigente en LUHO." );
