			...
			<form method='post'>
				<div class="row">	
					<div class="form-group col-md-4">
						<input type="text" name ="Buscar" class="form-control validate" id="buscar" placeholder="Buscar una categoria" autocomplete="off" maxlength="70" onkeypress="return alpha(event)">
			...
			<table class="table" ><!-- if using bootstrap this auto creates-->
				...
				<tbody>
					<?php
						...
						foreach($data as $row){
						$id=base64_url_encode($row['IdCategoria']);
						print("
						<tr>
							<td>$row[Categoria]</td>
							<td>$row[Genero]</td>
