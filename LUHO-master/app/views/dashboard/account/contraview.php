    ...
    <div class="container registeer cuenta">   
        <div class="row">
            <div class="form-group col-md-6">
                <input type="password" name ="clave1" class="form-control validate" id="clave1" placeholder="Contraseña">
                <label for="clave1" class="col-lg-2 control-label"></label>
            </div>
            <div class="form-group col-md-6">
                <input type="password" name ="clave2" class="form-control validate" id="clave2" placeholder="Contraseña">
