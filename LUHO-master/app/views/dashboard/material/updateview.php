<!-- Este es el formulario para modificar un material-->
<form method="post">
    <div class="container registeer cuenta">   
		<div class="col-sm-13 offset-sm-4 text-center">
			<div class="row">
            	<div class="form-group col-md-6">
					<input type="text" name ="Nombre" class="form-control validate" id="nombre" placeholder="Material"  autocomplete="off" maxlength="70" onkeypress="return alpha(event)" value="<?php print($material->getNombre()) ?>" required/>
