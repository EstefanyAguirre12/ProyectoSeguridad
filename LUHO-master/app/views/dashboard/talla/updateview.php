<form method="post">
<!-- Este es el formulario para modificar una talla-->
    <div class="container registeer cuenta">   
		<div class="col-sm-13 offset-sm-4 text-center">
			<div class="row">
            	<div class="form-group col-md-6">
					<input type="text" name ="Nombre" class="form-control validate" id="nombre" placeholder="Talla" autocomplete="off" maxlength="10" onkeypress="return num(event)" value="<?php print($talla->getNombre()) ?>" required/>
